...
class QuizBrain {
  ...
  //Function to get the question answer
  ...
  //Function to reset the quizzler
  void resetQuiz() {
    _questionNumber = 0;
  }

  //Function to get the question number
  int getQuestionNumber() {
    return _questionNumber;
  }

  //Function to get the questList length
  int getQuestListLength() {
